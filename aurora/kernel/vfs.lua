...
vfs.types = {
  ...
  sl   = { kind = "code",    label = "SimpleLang source", app = "studio", colour = colours.magenta,   char = "\187" },
  as   = { kind = "code",    label = "Assembly",         app = "studio", colour = colours.orange,    char = "\187" },
  ep   = { kind = "program", label = "Program",          app = nil,      colour = colours.lime,      char = "\16" },
  cae  = { kind = "library", label = "Library",          app = "studio", colour = colours.cyan,      char = "\4" },
